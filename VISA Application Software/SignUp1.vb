        ...
        If ValidateInputs() Then
            Try
                ...
                Using con As New MySqlConnection(My.Settings.conStr)
                    con.Open()
                    Dim qurey = "INSERT INTO `signup`(`FName`, `LName`, `Email`, `PNumber`, `UserName`, `DoB`, `Nationality`, `Gender`, `Password`, `Role`) VALUES (@FName,@LName,@Email,@PNumber,@UserName,@DoB,@Nationality,@Gender,@Password,'USER');"
